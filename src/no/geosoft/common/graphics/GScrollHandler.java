 ...
 */
final class GScrollHandler
  implements AdjustmentListener
{
  /** The scrollable scene. Non-null. */
  private final GScene scene_;

  /**
   * The horizontal scrollbar.
   * Null if we don't care about horizontal scrolling.
   */
  private final Adjustable hScrollBar_;

  /**
   * The vertical scrollbar.
   * Null if we don't care about vertical scrolling.
   */
   ...
   * <p>
   * <b>NOTE:</b> Do not use the scrollbars of a JScrollPane for this
   * purpose.
   *
  ...
  /**
   * Update the scrollbars according to the current setting
   * of the scene viewport and world extents.
   */
   ...
   *
   * @param event  Event trigging this method. Never null.
   */
