 ...
 * definition makes it possible to use any planar surface in 3D space
 * as world extent.
 * <p>
 ...
 */
public final class GWorldExtent
{
  ...
  private final double[] w0_ = new double[3];   // [x,y,z]
  private final double[] w1_ = new double[3];
  private final double[] w2_ = new double[3];
  ...
  void resize(double dx, double dy)
  {
    ...
    extendWidth(newWidth, 0.0); // Keep at left
    extendHeight(newHeight, 1.0); // Keep at top
  }
   ...
   * @param anchor    0.0 = Left, 0.5 = Center, 1.0 = Right.
   *                  and the values in between.
   */
  void extendWidth(double newWidth, double anchor)
  {
    ...
    Geometry.extendLine(w0_, w1_, newWidth, anchor);
   ...
   * @param anchor     0.0 = Top, 0.5 = Center, 1.0 = Bottom,
   *                   and the values in between.
   */
  void extendHeight(double newHeight, double anchor)
  {
    double oldW0[] = new double[3];
    oldW0[X] = w0_[X];
    oldW0[Y] = w0_[Y];
    ...
    Geometry.extendLine(w0_, w2_, newHeight, anchor);
  ...
  public String toString()
  {
    ...
    s.append("w0 = [" + w0_[0] + "," + w0_[1] + "," + w0_[2] + "]\n");
    s.append("w1 = [" + w1_[0] + "," + w1_[1] + "," + w1_[2] + "]\n");
    s.append("w2 = [" + w2_[0] + "," + w2_[1] + "," + w2_[2] + "]");
