...
public final class Geometry
{
   ...
   *
   * @param x0  X value of upper left corner of rectangle (inclusive).
   * @param y0  Y value of upper left corner of rectangle (inclusive).
   * @param x1  X value of lower left corner of rectangle.
   * @param y1  Y value of lower left corner of rectangle.
   ...
   * @param pointX  X value of point to check.
   * @param pointY  Y value of point to check.
   ...
   * @param p1              Second coordinale of line [x,y,z].
   ...
   *
   * @param  x0             X of first point defining the line.
   * @param  y0             Y of first point defining the line.
   * @param  x1             X of second point defining the line.
   * @param  y1             Y of second point defining the line.
   * @param  fractionFrom0  Distance from (x0,y0).
   * @return                Coordinate of point (x,y) we are looking for.
   */
   ...
   *
   * @param p0        First point [x,y,z] of line.
   * @param p1        Second point [x,y,z] of line.
   ...
   *
   * @param p0        First point [x,y,z] of line. Fixed during extension
   * @param p1        Second point [x,y,z] of line.
   * @param toLength  Length of new line segment.
   */
  public static void extendLine(double[] p0, double[] p1, double toLength)
   ...
   *
   * @param p0  First point [x,y,z].
   * @param p1  Second point [x,y,z].
   * @return    Distance between points. [0,&gt;.
   */
   ...
   *
   * @param x0  X of first line end point.
   * @param y0  Y of first line end point.
   * @param x1  X of first line end point.
   * @param y1  Y of first line end point.
   ...
   *
   * @param x        X coordinates of polyline. Non-null.
   * @param y        Y coordinates of polyline. Non-null.
   ...
   *
   * @param p0  First (center) point to consider (x,y,z).
   * @param p1  Second point to consider (x,y,z).
   * @param p2  Third point to consider (x,y,z).
   ...
   *
   * @param v0  First vector to compute dot product between (x,y,z).
   * @param v1  Second vector to compute dot product between (x,y,z).
   ...
   *
   * @param v0  First vector to compute cross product between (x,y,z).
   * @param v1  Second vector to compute cross product between (x,y,z).
   * @return    Cross product of specified vectors [x,y,z].
   */
   ...
   * @param x1  X coordinate of second point of line.
   * @param y1  Y coordinate of second point of line.
   * @param px0 X coordinate of first point to check.
   * @param py0 Y coordinate of first point to check.
   * @param px1 X coordinate of second point to check.
   * @param py1 Y coordinate of second point to check.
   ...
   *
   * @param x0  X coordinate of first point of line 1.
   * @param y0  Y coordinate of first point of line 1.
   * @param x1  X coordinate of second point of line 1.
   * @param y1  Y coordinate of second point of line 1.
   * @param x2  X coordinate of first point of line 2.
   * @param y2  Y coordinate of first point of line 2.
   * @param x3  X coordinate of second point of line 2.
   * @param y3  Y coordinate of second point of line 2.
   ...
   * Integer domain.
   *
   * @param lx0  X coordinate of first point of line.
   * @param ly0  Y coordinate of first point of line.
   * @param lx1  X coordinate of second point of line.
   * @param ly1  Y coordinate of second point of line.
   * @param x0   X coordinate of upper left corner of rectangle (inclusive).
   * @param y0   Y coordinate of upper left corner of rectangle (inclusive).
   * @param x1   X coordinate of lower right corner of rectangle (inclusive).
   * @param y1   Y coordinate of lower right corner of rectangle (inclusive).
   ...
   * Integer domain.
   *
   * @param x   X coordinate of polyline.
   * @param y   Y coordinate of polyline.
   * @param x0  X coordinate of upper left corner of rectangle (inclusive).
   * @param y0  Y coordinate of upper left corner of rectangle (inclusive).
   * @param x1  X coordinate of lower right corner of rectangle (inclusive).
   * @param y1  Y coordinate of lower right corner of rectangle (inclusive).
   ...
   * @return        Requested rectangle geometry. Never null.
   */
