...
/**
 * A time-less and immutable Date class for basic date arithmetic.
 *
  ...
  implements Comparable<Day>
{
  ...
  /**
   * Return a day which is a given number of month after this day.
   *
   ...
   * @return         Requested day. Never null.
   * @see #addMonths(int)
   */
  ...
  /**
   * Return a day which is a given number of years after this day.
   * <p>
  ...
  public int daysBetween(Day day)
  {
    ...
    return (int) Math.round(millisBetween / (1000.0 * 60 * 60 * 24));
  }
